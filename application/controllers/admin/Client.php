    ...
    public function delete_contacts($client_id, $id)
    {
        ...
        if (!empty($deleted)) {
            ...
            if (!empty($sbtn)) {
                ...
                $tickets_replies_info = $this->client_model->check_by(array('replierid' => $id), 'tbl_tickets_replies');
                if (!empty($tickets_replies_info)) {
            ...
            if (!empty($deleted)) {
                ...
                if (!empty($client_info)) {
                    foreach ($client_info as $v_client) {
                        ...
                        $this->user_model->delete_multiple(array('user' => $v_client->user_id));

                        $this->user_model->_table_name = 'tbl_inbox';
                        $this->user_model->delete_multiple(array('user_id' => $v_client->user_id));
                        ...
                        if (!empty($account_info)) {
                            ...
                            $this->user_model->delete_multiple(array('user_id' => $v_client->user_id));//delete user roll id
                        }
