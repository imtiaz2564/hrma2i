...
class Transactions extends Admin_Controller
{
    ...
    public function depositList($filterBy = null, $type = null)
    {
        if ($this->input->is_ajax_request()) {
            ...
            $this->datatables->column_order = array('tbl_transactions.name', 'tbl_accounts.account_name', 'date', 'notes', 'tbl_client.name', 'amount', 'reference');
            $this->datatables->column_search = array('tbl_transactions.name', 'tbl_accounts.account_name', 'date', 'notes', 'tbl_client.name', 'amount', 'reference');
...
//        redirect('admin/transactions/deposit');
    ...
    public function expenseList($filterBy = null, $type = null)
    {
        if ($this->input->is_ajax_request()) {
            ...
            $this->datatables->column_order = array('name', 'date', 'notes', 'tbl_accounts.account_name', 'amount', 'status', 'reference');
            $this->datatables->column_search = array('name', 'date', 'notes', 'tbl_accounts.account_name', 'amount', 'status', 'reference');
            $this->datatables->order = array('transactions_id' => 'desc');
            $where = null;
            if (empty($type)) {
