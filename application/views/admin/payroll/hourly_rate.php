...
<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs">
        <li class="<?= $active == 1 ? 'active' : ''; ?>"><a href="#manage"
                                                            data-toggle="tab">Daily Rate List<?//= lang('hourly_rate_list') ?></a>
        </li>
        <li class="<?= $active == 2 ? 'active' : ''; ?>"><a href="#create"
                                                            data-toggle="tab">Set Daily Rate<?//= lang('set_hourly_grade') ?></a></li>
    </ul>
        ...
        <div class="tab-pane <?= $active == 1 ? 'active' : ''; ?>" id="manage">
            ...
            <div class="panel panel-custom">
                <header class="panel-heading ">
                    <div class="panel-title"><strong>Daily Rate List<?//= lang('hourly_rate_list') ?></strong></div>
                </header>
                <?php } ?>
                <table class="table table-striped DataTables " id="DataTables" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <th>Daily Grade<?//= lang('hourly_grade') ?></th>
                        <th>Daily Rate<?//= lang('hourly_rates') ?></th>
                        <th>Days</th>
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-groups-bordered">
                                <div class="form-group" id="border-none">
                                    <label for="field-1" class="col-sm-3 control-label">Daily Grade<?//= lang('hourly_grade') ?><span
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        ?>" class="form-control" required
                                               placeholder="Daily Grade<?//= lang('enter') . ' ' . lang('hourly_grade') ?>">
                                    </div>
                                </div>
                                <div class="form-group" id="border-none">
                                    <label for="field-1" class="col-sm-3 control-label">Daily Rate<?//= lang('hourly_rates') ?><span
                                            class="required"> *</span></label>
                                    <div class="col-sm-5">
                                        ...
                                        ?>" class="salary form-control" required
                                               placeholder="Daily Rate<?//= lang('enter') . ' ' . lang('hourly_rates') ?>">
                                    </div>
                                </div>
                                <div class="form-group" id="border-none">
                                    <label for="field-1" class="col-sm-3 control-label">Days<span
                                            class="required"> *</span></label>
                                    <div class="col-sm-5">
                                        <input type="text" data-parsley-type="number" name="days" value="<?php
                                        if (!empty($hourly_rate->days)) {
                                            echo $hourly_rate->days;
                                        }
                                        ?>" class="salary form-control" required
                                               placeholder="Days">
                                    </div>
