    ...
    <div class="panel panel-custom">
        ...
        <div class="modal-body wrap-modal wrap">
            <form id="form_validation" data-parsley-validate="" novalidate="" enctype="multipart/form-data"
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">Training Hour</label>
                    <div class="col-sm-5">
                        <input type="text" name="training_hour" class="form-control" value="<?php
                        if (!empty($training_info->training_hour)) {
                            echo $training_info->training_hour;
                        }
                        ?>"/>
                    </div>
                </div>
