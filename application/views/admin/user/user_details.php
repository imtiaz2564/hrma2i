            ...
            <div class="tab-pane <?= $active == 1 ? 'active' : '' ?>" id="basic_info" style="position: relative;">
                <div class="panel panel-custom">
                    ...
                    <div class="panel-body form-horizontal">
                        ...
                        <?php } ?>
                        <div class="form-group mb0  col-sm-6">
                            <label class="col-sm-5 control-label">Contract Starts<?//= lang('joining_date') ?>: </label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group mb0  col-sm-6">
                            <label class="col-sm-5 control-label">Contract Ends: </label>
                            <div class="col-sm-7">
                                <?php if (!empty($profile_info->contract_ends)) { ?>
                                    <p class="form-control-static"><?php echo strftime(config_item('date_format'), strtotime($profile_info->contract_ends)); ?></p>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="form-group mb0  col-sm-6">
                            <label class="col-sm-5 control-label">Contract Duration: </label>
                            <? $date1 = new DateTime($profile_info->joining_date);
                                $date2 = new DateTime($profile_info->contract_ends);
                                $diff = $date1->diff($date2); ?>
                            <div class="col-sm-7">
                                <?php if (!empty($diff)) { ?>
                                    <p class="form-control-static"><?php echo $diff->y . " years " . $diff->m." months ".$diff->d." days "; ?></p>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="form-group mb0  col-sm-6">
                        ...
                        <div class="form-group mb0  col-sm-6">
                            <label class="col-sm-5 control-label">Cluster
                                : </label>
                            <div class="col-sm-7">
                                <p class="form-control-static"><?php echo  $dname; ?></p>
                            </div>
                        </div>             
                        <div class="form-group mb0  col-sm-6">
                            <label class="col-sm-5 control-label">Designation
                                : </label>
                            <div class="col-sm-7">
                                <p class="form-control-static"><?php $designation = $this->db->where('designations_id',$profile_info->designations_id)->get('tbl_designations')->row(); if(!empty($designation->designations)) echo $designation->designations; ?></p>
                            </div>
                        </div>
                        <div class="form-group mb0  col-sm-6">
                            <label class="col-sm-5 control-label">IT/NON IT
                                : </label>
                            <div class="col-sm-7">
                                <p class="form-control-static"><?php echo $profile_info->itNonIT; ?></p>
                            </div>
                        </div>
                        <div class="form-group mb0  col-sm-6">
                            <label class="col-sm-5 control-label">Team
                                : </label>
                            <div class="col-sm-7">
                                <p class="form-control-static"><?php $team = $this->db->where('teams_id',$profile_info->team_id)->get('tbl_teams')->row(); if(!empty($team->teams)) echo $team->teams; ?></p>
                            </div>
                        </div>
                        
                        <div class="form-group mb0  col-sm-6">
                            <label class="col-sm-5 control-label">Education
                                : </label>
                            <div class="col-sm-7">
                                <p class="form-control-static"><?php echo $profile_info->education; ?></p>
                            </div>
                        </div>
                        <? $transfer = $this->db->order_by("tbl_teamtransfer.teamtransfer_id", "desc")->where('employee',$this->uri->segment(4))->join('tbl_teams', 'tbl_teamtransfer.teamtransfer_id = tbl_teams.teams_id','left')->get('tbl_teamtransfer')->result();?>
                        <div class="form-group mb0  col-sm-5">
                        <fieldset>
                            <legend>Transfer Details</legend>
                            <table class="table table-striped table-report">
                            <? if(empty($transfer))  {?> 
                            <tr>No Transfer History</tr>
                            <?} else {?>
                                <tr>
                                    <td>Team From</td>
                                    <td>Team To</td>
                            ...
                            foreach($transfer as $transfer){ ?>
                                <tr>
                                <?  $teamFrom = $this->db->where('teams_id',$transfer->teamFrom)->get('tbl_teams')->row();  
                                    $teamTo = $this->db->where('teams_id',$transfer->teamTo)->get('tbl_teams')->row();
                                ?>
                                    <td><?=$teamFrom->teams?></td>
                                    <td><?=$teamTo->teams?></td>
                                    <td><?=$transfer->dateFrom?></td>
                                    <td><?=$transfer->dateTo?></td> 
                                </tr>  
                                <?  }  ?>
                            </table>
                        </fieldset>
                        </div>
                        <div class="form-group mb0  col-sm-1">
                        </div>
                        <? $experience = $this->db->order_by("tbl_experience.experience_id", "desc")->where('employee',$this->uri->segment(4))->get('tbl_experience')->result();?>
                        <div class="form-group mb0  col-sm-6">
                            <fieldset>
                                <legend>Experience Details</legend>
                                <table class="table table-striped table-report">
                                <? if(empty($experience))  {?> 
                                <tr>No Experience History</tr>
                                <?} else {?>
                                    <tr>
                                        <td>Company</td>
                                        <td>Designation</td>
